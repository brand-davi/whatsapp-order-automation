        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NeedsChange = table.Column<bool>(type: "boolean", nullable: true),
                    ChangeForAmount = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: true),
                    DeliveryCity = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: true),
                    DeliveryComplement = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: true),
                    DeliveryNeighborhood = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: true),
                    DeliveryNumber = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: true),
                    DeliveryPostalCode = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true),
                    DeliveryReference = table.Column<string>(type: "character varying(250)", maxLength: 250, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Conversations_Restaurants_RestaurantId",
                        column: x => x.RestaurantId,
                        principalTable: "Restaurants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PrintJobs_Restaurants_RestaurantId",
                        column: x => x.RestaurantId,
                        principalTable: "Restaurants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderId = table.Column<Guid>(type: "uuid", nullable: false),
                    MenuItemId = table.Column<Guid>(type: "uuid", nullable: false),
                    MenuItemVariantId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Conversations_RestaurantId",
                table: "Conversations",
                column: "RestaurantId");

            migrationBuilder.CreateIndex(
                name: "IX_Customers_RestaurantId_WhatsAppNumber",
                table: "Customers",
                columns: new[] { "RestaurantId", "WhatsAppNumber" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrintJobs_RestaurantId",
                table: "PrintJobs",
                column: "RestaurantId");

            migrationBuilder.CreateIndex(
                name: "IX_Restaurants_WhatsAppNumber",
                table: "Restaurants",
